...
public class Color {
    ...
    /** 0xED1C24. */
    public static final Color kFirstRed = new Color(0.9294117648, 0.1098039216, 0.1411764706, "kFirstRed");
    ...
    /** 0xFAEBD7. */
    public static final Color kAntiqueWhite = new Color(0.98039216f, 0.92156863f, 0.84313726f, "kAntiqueWhite");
    ...
    /** 0xFFEBCD. */
    public static final Color kBlanchedAlmond = new Color(1.0f, 0.92156863f, 0.8039216f, "kBlanchedAlmond");

    /** 0x0000FF. */
    public static final Color kBlue = new Color(0.0f, 0.0f, 1.0f, "kBlue");

    /** 0x8A2BE2. */
    public static final Color kBlueViolet = new Color(0.5411765f, 0.16862746f, 0.8862745f, "kBlueViolet");

    /** 0xA52A2A. */
    public static final Color kBrown = new Color(0.64705884f, 0.16470589f, 0.16470589f, "kBrown");

    /** 0xDEB887. */
    public static final Color kBurlywood = new Color(0.87058824f, 0.72156864f, 0.5294118f, "kBurlywood");

    /** 0x5F9EA0. */
    public static final Color kCadetBlue = new Color(0.37254903f, 0.61960787f, 0.627451f, "kCadetBlue");

    /** 0x7FFF00. */
    public static final Color kChartreuse = new Color(0.49803922f, 1.0f, 0.0f, "kChartreuse");

    /** 0xD2691E. */
    public static final Color kChocolate = new Color(0.8235294f, 0.4117647f, 0.11764706f, "kChocolate");

    /** 0xFF7F50. */
    public static final Color kCoral = new Color(1.0f, 0.49803922f, 0.3137255f, "kCoral");

    /** 0x6495ED. */
    public static final Color kCornflowerBlue = new Color(0.39215687f, 0.58431375f, 0.92941177f, "kCornflowerBlue");
    ...
    /** 0xB8860B. */
    public static final Color kDarkGoldenrod = new Color(0.72156864f, 0.5254902f, 0.043137256f, "kDarkGoldenrod");
    ...
    /** 0xBDB76B. */
    public static final Color kDarkKhaki = new Color(0.7411765f, 0.7176471f, 0.41960785f, "kDarkKhaki");

    /** 0x8B008B. */
    public static final Color kDarkMagenta = new Color(0.54509807f, 0.0f, 0.54509807f, "kDarkMagenta");

    /** 0x556B2F. */
    public static final Color kDarkOliveGreen = new Color(0.33333334f, 0.41960785f, 0.18431373f, "kDarkOliveGreen");
    ...
    /** 0xE9967A. */
    public static final Color kDarkSalmon = new Color(0.9137255f, 0.5882353f, 0.47843137f, "kDarkSalmon");

    /** 0x8FBC8F. */
    public static final Color kDarkSeaGreen = new Color(0.56078434f, 0.7372549f, 0.56078434f, "kDarkSeaGreen");

    /** 0x483D8B. */
    public static final Color kDarkSlateBlue = new Color(0.28235295f, 0.23921569f, 0.54509807f, "kDarkSlateBlue");

    /** 0x2F4F4F. */
    public static final Color kDarkSlateGray = new Color(0.18431373f, 0.30980393f, 0.30980393f, "kDarkSlateGray");

    /** 0x00CED1. */
    public static final Color kDarkTurquoise = new Color(0.0f, 0.80784315f, 0.81960785f, "kDarkTurquoise");
    ...
    /** 0xB22222. */
    public static final Color kFirebrick = new Color(0.69803923f, 0.13333334f, 0.13333334f, "kFirebrick");

    /** 0xFFFAF0. */
    public static final Color kFloralWhite = new Color(1.0f, 0.98039216f, 0.9411765f, "kFloralWhite");

    /** 0x228B22. */
    public static final Color kForestGreen = new Color(0.13333334f, 0.54509807f, 0.13333334f, "kForestGreen");

    /** 0xFF00FF. */
    public static final Color kFuchsia = new Color(1.0f, 0.0f, 1.0f, "kFuchsia");

    /** 0xDCDCDC. */
    public static final Color kGainsboro = new Color(0.8627451f, 0.8627451f, 0.8627451f, "kGainsboro");
    ...
    /** 0xDAA520. */
    public static final Color kGoldenrod = new Color(0.85490197f, 0.64705884f, 0.1254902f, "kGoldenrod");
    ...
    /** 0xCD5C5C. */
    public static final Color kIndianRed = new Color(0.8039216f, 0.36078432f, 0.36078432f, "kIndianRed");
    ...
    /** 0xFFF0F5. */
    public static final Color kLavenderBlush = new Color(1.0f, 0.9411765f, 0.9607843f, "kLavenderBlush");

    /** 0x7CFC00. */
    public static final Color kLawnGreen = new Color(0.4862745f, 0.9882353f, 0.0f, "kLawnGreen");

    /** 0xFFFACD. */
    public static final Color kLemonChiffon = new Color(1.0f, 0.98039216f, 0.8039216f, "kLemonChiffon");

    /** 0xADD8E6. */
    public static final Color kLightBlue = new Color(0.6784314f, 0.84705883f, 0.9019608f, "kLightBlue");

    /** 0xF08080. */
    public static final Color kLightCoral = new Color(0.9411765f, 0.5019608f, 0.5019608f, "kLightCoral");
    ...
    /** 0x90EE90. */
    public static final Color kLightGreen = new Color(0.5647059f, 0.93333334f, 0.5647059f, "kLightGreen");
    ...
    /** 0x20B2AA. */
    public static final Color kLightSeaGreen = new Color(0.1254902f, 0.69803923f, 0.6666667f, "kLightSeaGreen");

    /** 0x87CEFA. */
    public static final Color kLightSkyBlue = new Color(0.5294118f, 0.80784315f, 0.98039216f, "kLightSkyBlue");

    /** 0x778899. */
    public static final Color kLightSlateGray = new Color(0.46666667f, 0.53333336f, 0.6f, "kLightSlateGray");

    /** 0xB0C4DE. */
    public static final Color kLightSteelBlue = new Color(0.6901961f, 0.76862746f, 0.87058824f, "kLightSteelBlue");
    ...
    /** 0x32CD32. */
    public static final Color kLimeGreen = new Color(0.19607843f, 0.8039216f, 0.19607843f, "kLimeGreen");
    ...
    /** 0x66CDAA. */
    public static final Color kMediumAquamarine = new Color(0.4f, 0.8039216f, 0.6666667f, "kMediumAquamarine");

    /** 0x0000CD. */
    public static final Color kMediumBlue = new Color(0.0f, 0.0f, 0.8039216f, "kMediumBlue");

    /** 0xBA55D3. */
    public static final Color kMediumOrchid = new Color(0.7294118f, 0.33333334f, 0.827451f, "kMediumOrchid");

    /** 0x9370DB. */
    public static final Color kMediumPurple = new Color(0.5764706f, 0.4392157f, 0.85882354f, "kMediumPurple");

    /** 0x3CB371. */
    public static final Color kMediumSeaGreen = new Color(0.23529412f, 0.7019608f, 0.44313726f, "kMediumSeaGreen");

    /** 0x7B68EE. */
    public static final Color kMediumSlateBlue = new Color(0.48235294f, 0.40784314f, 0.93333334f, "kMediumSlateBlue");

    /** 0x00FA9A. */
    public static final Color kMediumSpringGreen = new Color(0.0f, 0.98039216f, 0.6039216f, "kMediumSpringGreen");

    /** 0x48D1CC. */
    public static final Color kMediumTurquoise = new Color(0.28235295f, 0.81960785f, 0.8f, "kMediumTurquoise");

    /** 0xC71585. */
    public static final Color kMediumVioletRed = new Color(0.78039217f, 0.08235294f, 0.52156866f, "kMediumVioletRed");

    /** 0x191970. */
    public static final Color kMidnightBlue = new Color(0.09803922f, 0.09803922f, 0.4392157f, "kMidnightBlue");
    ...
    /** 0x6B8E23. */
    public static final Color kOliveDrab = new Color(0.41960785f, 0.5568628f, 0.13725491f, "kOliveDrab");
    ...
    /** 0xEEE8AA. */
    public static final Color kPaleGoldenrod = new Color(0.93333334f, 0.9098039f, 0.6666667f, "kPaleGoldenrod");

    /** 0x98FB98. */
    public static final Color kPaleGreen = new Color(0.59607846f, 0.9843137f, 0.59607846f, "kPaleGreen");

    /** 0xAFEEEE. */
    public static final Color kPaleTurquoise = new Color(0.6862745f, 0.93333334f, 0.93333334f, "kPaleTurquoise");

    /** 0xDB7093. */
    public static final Color kPaleVioletRed = new Color(0.85882354f, 0.4392157f, 0.5764706f, "kPaleVioletRed");
    ...
    /** 0xB0E0E6. */
    public static final Color kPowderBlue = new Color(0.6901961f, 0.8784314f, 0.9019608f, "kPowderBlue");
    ...
    /** 0xBC8F8F. */
    public static final Color kRosyBrown = new Color(0.7372549f, 0.56078434f, 0.56078434f, "kRosyBrown");

    /** 0x4169E1. */
    public static final Color kRoyalBlue = new Color(0.25490198f, 0.4117647f, 0.88235295f, "kRoyalBlue");

    /** 0x8B4513. */
    public static final Color kSaddleBrown = new Color(0.54509807f, 0.27058825f, 0.07450981f, "kSaddleBrown");

    /** 0xFA8072. */
    public static final Color kSalmon = new Color(0.98039216f, 0.5019608f, 0.44705883f, "kSalmon");

    /** 0xF4A460. */
    public static final Color kSandyBrown = new Color(0.95686275f, 0.6431373f, 0.3764706f, "kSandyBrown");

    /** 0x2E8B57. */
    public static final Color kSeaGreen = new Color(0.18039216f, 0.54509807f, 0.34117648f, "kSeaGreen");
    ...
    /** 0x6A5ACD. */
    public static final Color kSlateBlue = new Color(0.41568628f, 0.3529412f, 0.8039216f, "kSlateBlue");

    /** 0x708090. */
    public static final Color kSlateGray = new Color(0.4392157f, 0.5019608f, 0.5647059f, "kSlateGray");
    ...
    /** 0x4682B4. */
    public static final Color kSteelBlue = new Color(0.27450982f, 0.50980395f, 0.7058824f, "kSteelBlue");
    ...
    /** 0x40E0D0. */
    public static final Color kTurquoise = new Color(0.2509804f, 0.8784314f, 0.8156863f, "kTurquoise");
    ...
    /** 0xF5F5F5. */
    public static final Color kWhiteSmoke = new Color(0.9607843f, 0.9607843f, 0.9607843f, "kWhiteSmoke");

    /** 0xFFFF00. */
    public static final Color kYellow = new Color(1.0f, 1.0f, 0.0f, "kYellow");

    /** 0x9ACD32. */
    public static final Color kYellowGreen = new Color(0.6039216f, 0.8039216f, 0.19607843f, "kYellowGreen");
}
